...
<html>
    ...
    <body>
        ...
        <h3>Please select  the destination where you would like to go:</h3>
        <form action='SessionServlet' method='post'>
            <center>
                <label class="label5" for='Destination'><b>Select Destination:<b></label>
                            <select name='Destination' id='Destination'>
                                ...
                                <input class="btn btn-outline-light" type='submit' value='Next'>
